...
$.widget("ui.selectmenu", {
	_init: function() {
		...
		this.list.find('li:first').addClass("ui-corner-top"); //custom edit
	...
	open: function(event){
		...
		$('#fnLanguagesNav').css("display","none");
		$('.searchMenu.ui-selectmenu-menu').css("display","block");
		this.list
			.appendTo('body')
	...
	close: function(event, retainFocus){
		if(this.newelement.is('.ui-state-active')){
			...
			$('.searchMenu.ui-selectmenu-menu').css("display","none");
	...
	_refreshPosition: function(){	
		//set left value
		this.list.css('left', this.newelement.offset().left-10);
