# -*- coding: utf-8 -*-
"""
Migration adds project watched/unwatched event types
"""
...
class ProjectWatchedEventTypes(MigrateBase):
...
MigrateMgr.instance().add(ProjectWatchedEventTypes())