...
class PermissionCacheTestCase(CQDETestCase):
    ...
    def testGroupPerms(self):
        # Init test
        self.cache.clear_group_perms(563)
        self.assertEquals(self.cache.get_group_perms(563), None)
        
        # Set test
        self.cache.set_group_perms(563, [('groupname', 'TRAC_ADMIN'),('group2name', 'VIEW')])
        self.assertEquals(self.cache.get_group_perms(563), [('groupname', 'TRAC_ADMIN'),('group2name', 'VIEW')])
